<x-dashboard-master>
    ...
    @section('main')
    <form action="{{route('dashboard.category.update' , $category)}}" method="post" id="form">
        @csrf
        @method('PUT')
        <div class="col-lg-12">
            <div class="card">
        ...
        <form action="{{route('dashboard.category.store')}}" method="post" id="form">
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="container">
                        <label class="form-control-label " style="margin-top:2rem;" for="posttitleid">Image
                            Category</label>
                        <div class="controls">
                            <div class="input-group">
                                <input id="fileinputid" class="form-control" name="image" type="file">
                    ...
                    <div class="card-block">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            show active in
                             @endif" id="{{$key}}" role="tabpanel" aria-labelledby="pills-home-tab" tabindex="0">
                                <label class="form-control-label " style="margin-top:2rem;" for="posttitleid">Category
                                    Title
                                    _{{$key}}</label>
                                <div class="controls">
                                    <div class="input-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <button class="btn btn-danger btn-block " style="margin-top:2rem;"
                                    onclick="resetFun(event)" type="button" id="reset">reset</button>
                            </div>
                        </div>
                    </div>
                </div>
