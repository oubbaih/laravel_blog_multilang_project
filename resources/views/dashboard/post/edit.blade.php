<x-dashboard-master>
    ...
    @endsection
    @section('main')
    <form action="{{route('dashboard.post.update' , $post)}}" method="post" id="form" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <div class="form-group " style="margin-top:2rem">
                        ...
                        <select class="form-control" id="exampleFormControlSelect1" name="category_id">
                            <option value="0" @if ($post->category_id === 0)
                                selected
                        ...
                        <div class="tab-pane fade @if ($loop->index == 0)
                            ...
                            <div class="controls">
                                <div class="input-group">
                                    <input id="posttitleid" class="form-control" name="{{$key}}[title]" type="text" value="{{$post->translate($key)->title}}">
                                </div>
                            </div>
                            ...
                            <div class="controls">
                                <div class="input-group">
                                    <textarea id="postContentid" class="form-control" name="{{$key}}[content]"
                                        rows="25">{!! $post->translate($key)->content !!}</textarea>
                                </div>
                            </div>
                        </div>
                        @endforeach
