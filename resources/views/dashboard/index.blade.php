        ...
        <header class="navbar">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav hidden-md-down">
                    <li class="nav-item">
                        <a
                            class="nav-link navbar-toggler layout-toggler"
                            href="#"
                            >&#9776;</a
                        >
                    </li>
                ...
                <ul class="nav navbar-nav pull-left hidden-md-down">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            >
                            <a class="dropdown-item" href="#"
                                ><i class="fa fa-tasks"></i> Tasks<span
                                    class="tag tag-danger"
                                    >42</span
                                ></a
                            >
                            <a class="dropdown-item" href="#"
                                ><i class="fa fa-comments"></i> Comments<span
                            ...
                            >
                            <a class="dropdown-item" href="#"
                                ><i class="fa fa-usd"></i> Payments<span
                                    class="tag tag-default"
                                    >42</span
                                ></a
                            >
                            <a class="dropdown-item" href="#"
                                ><i class="fa fa-file"></i> Projects<span
                        ...
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <a
                                    ...
                                    ><i class="icon-puzzle"></i> Buttons</a
                                >
                            </li>
                            <li class="nav-item">
                                <a
                                    class="nav-link"
                                    href="components-social-buttons.html"
                                    ><i class="icon-puzzle"></i> Social
                                    Buttons</a
                                >
                            </li>
                            <li class="nav-item">
                        ...
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <a
                                    ...
                                    ><i class="icon-star"></i> Font Awesome</a
                                >
                            </li>
                            <li class="nav-item">
                                <a
                                    ...
                                    ><i class="icon-star"></i> Simple Line
                                    Icons</a
                                >
                            </li>
                        </ul>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            ...
                                            <ul class="icons-list">
                                                <li>
                                                    <i
                                                        class="icon-screen-desktop bg-primary"
                                                    ></i>
                                                    <div class="desc">
                                                        <div class="title">
                                                            iMac 4k
                                                ...
                                                <li>
                                                    <i
                                                        class="icon-screen-smartphone bg-info"
                                                    ></i>
                                                    <div class="desc">
                                                        <div class="title">
                                                            Samsung Galaxy Edge
                                                ...
                                                <li>
                                                    <i
                                                        class="icon-screen-smartphone bg-warning"
                                                    ></i>
                                                    <div class="desc">
                                                        <div class="title">
                                                            iPhone 6S
                                                ...
                                                <li>
                                                    <i
                                                        class="icon-social-spotify bg-success"
                                                    ></i>
                                                    <div class="desc">
                                                        <div class="title">
                                                            Spotify
                                                ...
                                                <li>
                                                    <i
                                                        class="icon-cloud-download bg-danger"
                                                    ></i>
                                                    <div class="desc">
                                                        <div class="title">
                                                            Ebook
                                            ...
                                            <tr>
                                                <td class="text-xs-center">
                                                    <div class="avatar">
                                                        ...
                                                        />
                                                        <span
                                                            class="avatar-status tag-success"
                                                        ></span>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td class="text-xs-center">
                                                    <div class="avatar">
                                                        ...
                                                        />
                                                        <span
                                                            class="avatar-status tag-danger"
                                                        ></span>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td class="text-xs-center">
                                                    <div class="avatar">
                                                        ...
                                                        />
                                                        <span
                                                            class="avatar-status tag-warning"
                                                        ></span>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td class="text-xs-center">
                                                    <div class="avatar">
                                                        ...
                                                        />
                                                        <span
                                                            class="avatar-status tag-default"
                                                        ></span>
                                                    </div>
                                                </td>
                                                <td>
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="timeline" role="tabpanel">
                    ...
                    <div class="callout callout-danger m-a-0 p-y-1">
                        ...
                        >
                        <small class="text-muted"
                            ><i class="icon-home"></i>&nbsp; creativeLabs
                            HQ</small
                        >
                ...
                <div class="tab-pane p-a-1" id="messages" role="tabpanel">
                    <div class="message">
                        ...
                        <div>
                            ...
                            <small class="text-muted pull-left m-t-q"
                                >1:52 PM</small
                            >
                        </div>
                    ...
                    <div class="message">
                        ...
                        <div>
                            <small class="text-muted">Lukasz Holeczek</small>
                            <small class="text-muted pull-right m-t-q"
                                >1:52 PM</small
                            >
                        </div>
                        <div class="text-truncate font-weight-bold">
